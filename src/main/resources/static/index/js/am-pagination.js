            ...
            createUITmp:function(copts,celem){ //cpgidx,ctotals,cboundaryLinks,cfirstText,cpageCount,clastText,cprevText,cnextText,cuiType,cspage,cepage
                ...
                if(copts.cuiType==='amazeui'){
                        ...
                        if (copts.cboundaryLinks === true) {
                            htm.push('<li  class=" pager-first ' + (copts.cpgidx === 0 || copts.ctotals<=0 ? 'am-disabled' : '') + '" ><a href="javascript:void(0)">' + copts.cfirstText + '</a></li>');
                        }

                        if (copts.cdirectionLinks === true) {
                            htm.push('<li  class=" pager-prev   ' + (copts.cpgidx === 0 ||copts.ctotals<= 0? 'am-disabled' : '') + '  "><a href="javascript:void(0)">' + copts.cprevText + '</a></li>');
                        }
                        ...
                        for (var i = copts.cspage; i < copts.cepage; i++) {
                            htm.push('<li ' + (copts.cpgidx === i ? 'class="am-active"' : "") + '><a href="javascript:void(0)">' + (i + 1) + '</a></li>');
                        }
                        if (copts.cepage !== copts.cpageCount) {
                            htm.push('<li><span>...</span></li>');
                        }
                        if (copts.cdirectionLinks === true) {
                            htm.push(' <li class="pager-next ' + (copts.cpgidx === copts.cpageCount - 1 || copts.ctotals <= 0 ? 'am-disabled ' : '') + '"><a href="javascript:void(0)">' + copts.cnextText + '</a></li>');
                        }
                        if (copts.cboundaryLinks === true) {
                            htm.push(' <li class=" pager-last ' + (copts.cpgidx === copts.cpageCount - 1 || copts.ctotals <= 0? 'am-disabled' : '') + '"><a href="javascript:void(0)">' + copts.clastText + '</a></li>');
                        }
                        ...
                        if(!celem.hasClass('pagination')){
                         ...
                         if (copts.cboundaryLinks === true) {
                            htm.push('<li  class=" pager-first ' + (copts.cpgidx === 0 || copts.ctotals<=0 ? 'disabled' : '') + '" ><a href="javascript:void(0)">' + copts.cfirstText + '</a></li>');
                        }

                        if (copts.cdirectionLinks === true) {
                            htm.push('<li  class=" pager-prev   ' + (copts.cpgidx === 0 ||copts.ctotals<= 0? 'disabled' : '') + '  "><a href="javascript:void(0)">' + copts.cprevText + '</a></li>');
                        }
                        ...
                        for (var i = copts.cspage; i < copts.cepage; i++) {
                            htm.push('<li ' + (copts.cpgidx === i ? 'class="active"' : "") + '><a href="javascript:void(0)">' + (i + 1) + '</a></li>');
                        }
                        if (copts.cepage !== copts.cpageCount) {
                            htm.push('<li><span>...</span></li>');
                        }
                        if (copts.cdirectionLinks === true) {
                            htm.push(' <li class="pager-next ' + (copts.cpgidx === copts.cpageCount - 1 || copts.ctotals <= 0 ? 'disabled ' : '') + '"><a href="javascript:void(0)">' + copts.cnextText + '</a></li>');
                        }
                        if (copts.cboundaryLinks === true) {
                            htm.push(' <li class=" pager-last ' + (copts.cpgidx === copts.cpageCount - 1 || copts.ctotals <= 0? 'disabled' : '') + '"><a href="javascript:void(0)">' + copts.clastText + '</a></li>');
                        }
                }else{
